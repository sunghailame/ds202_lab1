...
3. Partner: Modify `partner_YourName.Rmd` to include the following information. Knit it when finished.
   ...
   + Your (the "Partner's") full name and GitHub username. Elcy Timothy; etimothy
   + What did the Owner do in the most recent commit? What is the commit ID? added owner file b21l7cf
   ...
   I was not able to create a github account with my school email
